...
export default function HeroSection({ stats = defaultStats }: HeroSectionProps) {
    ...
    <section className="relative flex min-h-[100svh] items-center overflow-hidden bg-background px-6 md:px-8">
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-12 py-24 lg:grid-cols-12 lg:py-0">
        ...
        >
          ...
          >
            Designing <em className="serif-italic text-primary not-italic">Smart</em>
            <br />
            Living Spaces
          </motion.h1>
          ...
          >
            Creating elegant and functional interiors that resonate with your
