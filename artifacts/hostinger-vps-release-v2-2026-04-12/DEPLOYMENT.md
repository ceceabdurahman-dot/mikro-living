...
- For Hostinger VPS with LiteSpeed/OpenLiteSpeed, use the Hostinger-specific guide at [deploy/HOSTINGER_VPS_LITESPEED.md](E:\xampp\htdocs\mikro-living\deploy\HOSTINGER_VPS_LITESPEED.md), the env template at [\.env.production.hostinger-vps.example](E:\xampp\htdocs\mikro-living\.env.production.hostinger-vps.example), and the PM2 stack at [ecosystem.hostinger.cjs](E:\xampp\htdocs\mikro-living\ecosystem.hostinger.cjs).
