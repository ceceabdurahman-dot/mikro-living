...
authRouter.post('/logout', tryAuthenticate, authCtrl.logout)
authRouter.get('/me', authenticate, authCtrl.me)
authRouter.put('/change-password', authenticate, authCtrl.changePassword)
authRouter.get('/users', authenticate, adminOnly, authCtrl.listUsers)
authRouter.post('/users', authenticate, adminOnly, uploadAvatar.single('avatar'), authCtrl.createUser)
authRouter.put('/users/bulk-status', authenticate, adminOnly, authCtrl.bulkUpdateUserStatus)
authRouter.put('/users/:id', authenticate, adminOnly, uploadAvatar.single('avatar'), authCtrl.updateUser)
authRouter.put('/users/:id/password', authenticate, adminOnly, authCtrl.resetUserPassword)
authRouter.delete('/users/:id', authenticate, adminOnly, authCtrl.deleteUser)
...
settingRouter.get('/', authenticate, adminOnly, settingCtrl.getAll)
settingRouter.get('/:key', tryAuthenticate, settingCtrl.get)
